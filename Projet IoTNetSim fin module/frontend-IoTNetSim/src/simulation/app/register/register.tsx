...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      formData.password.toUpperCase() === 'ADMIN'
    ) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="flex flex-wrap w-full max-w-5xl bg-white shadow-md rounded-lg overflow-hidden">
        {/* Left Side */}
        <div className="hidden xl:block xl:w-1/2 bg-blue-50">
          <div className="p-12 text-center">
            <Link to="/">
              <img className="hidden dark:block mb-4" src={Logo} alt="Logo" />
              <img className="dark:hidden mb-4" src={LogoDark} alt="Logo" />
            </Link>
            <p className="text-lg text-gray-600">
              Join the best simulation experience.
            </p>
        ...
        <div className="w-full xl:w-1/2 p-8 sm:p-12">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-800 focus:outline-none focus:ring focus:ring-blue-300"
            >
              Register
            </button>
          </form>
